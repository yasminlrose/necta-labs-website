...
export const products: Record<ProductSlug, ProductData> = {
  focus: {
    ...
    heroIngredientsSummary: "Lion's Mane 2g • L-Theanine 80mg • Rhodiola 200mg",
    ...
    ingredients: [
      { name: "Lion's Mane", dose: "2g", benefit: "Supports brain health, memory, and focus by promoting nerve growth." },
