...
export const products: Record<ProductSlug, ProductData> = {
  focus: {
    ...
    bottleImage: bottleFocus,
    sachetImage: sachetFocus,
  ...
  immunity: {
    ...
    bottleImage: bottleImmunity,
    sachetImage: sachetImmunity,
  ...
  calm: {
    ...
    bottleImage: bottleCalm,
    sachetImage: sachetCalm,
  ...
  glow: {
    ...
    bottleImage: bottleGlow,
    sachetImage: sachetGlow,
